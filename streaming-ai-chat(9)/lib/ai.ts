 ...
 * Using gemini-3.5-flash for fast, reliable, and responsive streaming chat interactions.
 */
...
- When the user explicitly asks to analyze, inspect, or audit a specific website URL, invoke the analyzeWebsite tool with the provided HTTP/HTTPS URL.
- Do NOT invent or hallucinate URLs.
- Do NOT invoke the analyzeWebsite tool for general conversational questions, coding questions, or general queries.
